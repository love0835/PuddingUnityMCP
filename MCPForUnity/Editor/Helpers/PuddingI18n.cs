...
namespace MCPForUnity.Editor.Helpers
{
    ...
    internal static class PuddingI18n
    {
        ...
        private static readonly Dictionary<string, Dictionary<string, string>> _zhTW = new()
        {
            ...
            ["PuddingUnityMCP Setup"] = new() { ["zh_TW"] = "PuddingUnityMCP 設定" },
            ["PuddingUnityMCP requires Python 3.10+ and UV package manager to function."] = new() { ["zh_TW"] = "PuddingUnityMCP 需要 Python 3.10+ 與 UV package manager 才能運作。" },
