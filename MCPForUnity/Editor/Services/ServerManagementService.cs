    ...
    public class ServerManagementService : IServerManagementService
    {
        ...
        public bool StartLocalHttpServer(bool quiet = false)
        {
            ...
            try
            {
                ...
                // chosen via Window > MCP for Unity > Pudding Settings. The headless process
                // inherits these directly, replacing the old terminal `export` mechanism.
                foreach (var kv in Helpers.PuddingServerEnv.BuildEnv())
                {
